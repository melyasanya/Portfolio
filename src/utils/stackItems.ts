...
export const stackItems = [
  ...
  },
  {
    name: "Typescript",
    logo: TsLogo,
    shortDescr: "Strongly Typed Superset of JavaScript ",
    longDescr:
      "I use TypeScript to write more robust and scalable JavaScript code by adding static typing. It helps catch errors early in the development process, improves code maintainability, and enhances productivity through features like code navigation and intelligent auto-completion.",
  },
  {
    name: "React",
    logo: ReactLogo,
